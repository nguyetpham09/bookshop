...
namespace TeduShop.Web
{
    public class RouteConfig
    {
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute(
                 name: "Personal",
                 url: "tai-khoan-{id}.html",
                 defaults: new { controller = "Account", action = "AccountInformation", id = UrlParameter.Optional },
                 namespaces: new string[] { "TeduShop.Web.Controllers" }
             );

            routes.MapRoute(
                 name: "Profile",
                 url: "thong-tin-tai-khoan-{id}.html",
