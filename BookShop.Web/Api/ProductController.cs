...
namespace TeduShop.Web.Api
{
    ...
    public class ProductController : ApiControllerBase
    {
        ...
        public ProductController(IErrorService errorService, IProductService productService, IOrderService orderService)
            : base(errorService)
        {
        ...
        [Route("updateorder")]
        [HttpPut]
        public HttpResponseMessage UpdateOrder(HttpRequestMessage request, OrderInformationViewModel orderInfoViewModel)
        {
            return CreateHttpResponse(request, () =>
            {
                HttpResponseMessage response = null;
                ...
                {
                    var dbOrder = _orderService.GetOrderInformationByOrderId(orderInfoViewModel.OrderId);
                    ...
                    var responseData = Mapper.Map<OrderInformation, OrderInformationViewModel>(dbOrder);
                    response = request.CreateResponse(HttpStatusCode.Created, responseData);
                }
